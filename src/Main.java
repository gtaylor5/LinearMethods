...
class Main{
    ...
    void test(){
      ...
      l.initializeClasses();
      l.gradientDescent();
      System.out.printf("%.2f", l.test()*100);
      System.out.println();
    
      //Naive Bayes
    
      BayesTrainer b = new BayesTrainer(this.dataSetName);
      ...
      p.validationSet = this.validationSet;
      p.countClasses();
      p.setNeurons();
      p.trainPerceptron();
      p.testPerceptron();
      ...
      a.validationSet = this.validationSet;
      a.countClasses();
      a.setNeurons();
      a.trainAdaline();
      a.testAdaline();
